        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl font-medium leading-tight mb-6 text-white">
              Water Damage <span className="text-red-600">Restoration</span>
            </h1>
            <p className="text-lg text-slate-200 mb-8 leading-relaxed">
              Rapid response water damage restoration services. We arrive in <span className="text-white font-medium underline decoration-red-600">60 minutes or less</span> to minimize damage and restore your property.
            </p>
      ...
      <section className="py-24 bg-slate-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-16">
            ...
            <h3 className="text-3xl font-medium text-white mb-2">Our Water Damage Services</h3>
            <p className="text-slate-400 text-lg">
              Comprehensive water damage restoration to return your property to pre-loss condition.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-slate-800 rounded-2xl p-8 border border-slate-700">
              ...
              <h3 className="text-lg font-medium text-white mb-3">Water Extraction</h3>
              <p className="text-slate-300 leading-relaxed text-base">
                Fast and efficient water removal using professional equipment to prevent further damage.
              </p>
            </div>
            <div className="bg-slate-800 rounded-2xl p-8 border border-slate-700">
              <div className="w-16 h-16 bg-red-600/10 rounded-xl flex items-center justify-center mb-6 text-3xl">
              ...
              <h3 className="text-lg font-medium text-white mb-3">Flood Cleanup</h3>
              <p className="text-slate-300 leading-relaxed text-base">
                Comprehensive flood cleanup and restoration services for all types of flooding.
              </p>
            </div>
            <div className="bg-slate-800 rounded-2xl p-8 border border-slate-700">
              <div className="w-16 h-16 bg-red-600/10 rounded-xl flex items-center justify-center mb-6 text-3xl">
              ...
              <h3 className="text-lg font-medium text-white mb-3">Structural Drying</h3>
              <p className="text-slate-300 leading-relaxed text-base">
                Advanced drying techniques to prevent mold and structural damage.
              </p>
            </div>
          </div>
        </div>

        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl font-medium leading-tight mb-6 text-white">
              Professional <span className="text-red-600">Plumbing Services</span>
            </h1>
            <p className="text-lg text-slate-200 mb-8 leading-relaxed">
              Expert plumbing solutions when you need them most. Emergency response in <span className="text-white font-medium underline decoration-red-600">60 minutes or less</span>.
            </p>
      ...
      <section className="py-24 bg-slate-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-16">
            ...
            <h3 className="text-3xl font-medium text-white mb-2">Our Plumbing Services</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-slate-800 rounded-2xl p-8 border border-slate-700">
              ...
              <h3 className="text-lg font-medium text-white mb-3">Emergency Plumbing</h3>
              <p className="text-slate-300 leading-relaxed text-base">
                24/7 emergency response for urgent plumbing issues. We arrive fast to prevent further damage.
              </p>
            </div>
            <div className="bg-slate-800 rounded-2xl p-8 border border-slate-700">
              <div className="w-16 h-16 bg-red-600/10 rounded-xl flex items-center justify-center mb-6 text-3xl">
              ...
              <h3 className="text-lg font-medium text-white mb-3">Pipe Repair & Replacement</h3>
              <p className="text-slate-300 leading-relaxed text-base">
                Expert pipe repair and replacement services using the latest techniques and materials.
              </p>
            </div>
            <div className="bg-slate-800 rounded-2xl p-8 border border-slate-700">
              <div className="w-16 h-16 bg-red-600/10 rounded-xl flex items-center justify-center mb-6 text-3xl">
              ...
              <h3 className="text-lg font-medium text-white mb-3">Leak Detection & Repair</h3>
              <p className="text-slate-300 leading-relaxed text-base">
                Advanced leak detection technology to find and fix leaks before they cause major damage.
              </p>
            </div>
          </div>
        </div>

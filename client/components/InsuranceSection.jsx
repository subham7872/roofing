  ...
  return (
    <section className="py-16 bg-slate-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-slate-800 rounded-[3rem] p-8 md:p-12 overflow-hidden relative">
          ...
          <div className="relative flex flex-col lg:flex-row items-center space-y-8 lg:space-y-0 lg:space-x-12">
            <div className="flex-1 space-y-6">
              <div>
                <h2 className="text-xs font-medium text-red-500 uppercase tracking-widest mb-3">Insurance Claims</h2>
